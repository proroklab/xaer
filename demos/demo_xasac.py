...
CONFIG.update({
	...
	###########################
	"tau": 5e-4, # The smaller tau, the lower the value over-estimation, the higher the bias
...
train(XASACTrainer, CONFIG, SELECT_ENV, test_every_n_step=1000, stop_training_after_n_step=None)
