...
CONFIG.update({
	...
	"buffer_options": {
		...
		'weight_importance_by_update_time': True, # Whether to weight more those batches with an up-to-date priority # Idea from: Fedus, William, et al. "Revisiting fundamentals of experience replay." International Conference on Machine Learning. PMLR, 2020.
	},
...
train(XADDPGTrainer, CONFIG, SELECT_ENV, test_every_n_step=1e6, stop_training_after_n_step=None)
