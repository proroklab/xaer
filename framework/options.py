...
# Gradient optimization parameters
	...
	options["network_configuration"] = "ExplicitlyRelational" # "neural network configurations: Base, Towers, HybridTowers, SA, OpenAISmall, OpenAILarge, Impala, ExplicitlyRelational, ExplicitlyArgumentative"
