...
## V5
register_env("GraphDrive-Easy-V5", lambda config: GraphDrive({"reward_fn": 'frequent_reward_step_multiplied_by_junctions', "culture_level": "Easy"}))
register_env("GraphDrive-Medium-V5", lambda config: GraphDrive({"reward_fn": 'frequent_reward_step_multiplied_by_junctions', "culture_level": "Medium"}))
register_env("GraphDrive-Hard-V5", lambda config: GraphDrive({"reward_fn": 'frequent_reward_step_multiplied_by_junctions', "culture_level": "Hard"}))
## V1
