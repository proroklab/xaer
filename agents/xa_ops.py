...
def get_clustered_replay_buffer(config):
	assert config["batch_mode"] == "complete_episodes" or config["clustering_scheme"] == "none", "This algorithm requires 'complete_episodes' as batch_mode when 'clustering_scheme' != 'none'"
