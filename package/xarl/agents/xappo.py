...
XAPPO_EXTRA_OPTIONS = {
	...
	"buffer_options": {
		...
		'prioritised_cluster_sampling_smoothness_degree': 2, # The higher it is, the more uniform cluster sampling will be. This is how many standard deviations to consider for estimating the maximum priority in eta-normalisation of clusters' priorities.
